...
## Classes
A função da classe Bibliotecário é supervisionar as atividades de uma biblioteca, dispondo de métodos para realizar o cadastro, atualização, empréstimo, devolução e pesquisa de livros e usuários.
